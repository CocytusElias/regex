...
export const androidExecFile = /\.(apk|aab)$/i;

export const macosExecFile = /\.(app|pkg|dmg)$/i;

export const windowsExecFile = /\.(exe|bat|msi)$/i;

export const linuxExecFile = /\.(sh)$/i;

export const cmpFile = /\.(zip|rar|7a|gz)$/i;
